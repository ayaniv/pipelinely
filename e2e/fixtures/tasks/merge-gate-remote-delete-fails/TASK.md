# Merge gate fixture (merge-gate-remote-delete-fails)

## Workspace
- Repo: merge-gate-repo
- Branch: claude/merge-gate-remote-delete-fails
- Branch status: existing

## Mode: implement

## Context
Fixture task for e2e/pipelinely-merge-gate.spec.ts — not real work. Its repo,
