...
`pipelinely-planning` applies this same discipline when deciding flat-vs-milestone
...
- **Complex** — everything else: new component or page, contained feature,
  ...
  `/pipelinely-plan-review` → `/pipelinely-dev` → `/pipelinely-cr` → `/pipelinely-qa`
